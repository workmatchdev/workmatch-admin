...
import useUpdatePolicy from "@/components/Forms/UpdatePolicy/hooks/useUpdatePolicy";
...
const TermsAndConditions = () => {
    ...
    const { initialValues } = useUpdatePolicy({ setShowModal: () => { } });
    const { politicaDePrivacidad } = initialValues || {};
    ...
    return (
        <div>
            ...
            <div className="p-6 max-w-[1400px] mx-auto">
                <div dangerouslySetInnerHTML={{ __html: politicaDePrivacidad }} />;
            </div>
            {!isLoading && (
