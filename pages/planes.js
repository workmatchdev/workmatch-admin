            ...
            <div className="my-8">
                ...
                <div>
                    <div className="flex flex-row items-center justify-between bg-gray-100 px-4 py-2">
                        <p className="font-light text-xl w-1/5">Plan basico</p>
                        <p className="font-light text-xl w-1/5"> $ 315.00 MXN</p>
                        <p className="font-light text-xl w-1/5"> Plan aspirante</p>
                        <div className="w-1/5">
