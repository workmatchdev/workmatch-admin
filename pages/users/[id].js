...
const User = () => {
    useSession();
    const { currentUser, isLoading, changeUserStatus } = useGetUser();
    const {
        email,
        image,
        lastName,
                ...
                <div className="w-1/5 mr-4 bg-gray-100 h-[800px] p-4">
                    ...
                    <div className="flex flex-row items-center mt-4">
                        ...
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" value="" onClick={() => changeUserStatus(_id)} class="sr-only peer outline-none" checked={!status} />
