...
const JointLineScatterChart = () => {
    return (
        <div className="bg-gray-200 mt-10 p-4 mb-4">
            <h2 className="py-5 text-xl font-bold text-center">Ingresos generados</h2>
            <div className="flex flex-row justify-end pr-8 pb-3">
                <div className="flex flex-col items-start">
                    <label className="font-bold m-3">Año seleccionado</label>
            ...
            <div className='bg-white p-3 w-full overflow-auto'>
                <LineChart
                    width={1300}
                    height={300}
                    data={data}
